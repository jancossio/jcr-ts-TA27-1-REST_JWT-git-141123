...
public class PiezaController {
	...
	@GetMapping("{id}")
	public Pieza cursoXID(@PathVariable(name="id") Integer codigo) {
	...
	@PutMapping("{id}")
	public Pieza actualizarCurso(@PathVariable(name="id")Integer codigo,@RequestBody Pieza pieza) {
	...
	@DeleteMapping("{id}")
	public void eleiminarCurso(@PathVariable(name="id")Integer codigo) {
